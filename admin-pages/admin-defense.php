                    ...
                    <div id="schedulesContent" class="main-tab-content">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                            ...
                            <div class="flex gap-3 relative z-50">
                                ...
                                <button onclick="openPreOralDefenseModal()" class="gradient-blue text-white px-6 py-3 rounded-xl flex items-center font-semibold transition-all duration-300 hover:shadow-lg hover:scale-105">
                                    <i class="fas fa-graduation-cap mr-2"></i> Enable Pre-Oral Defense
                                </button>
                            </div>
                        </div>
                    </div>
...
<div id="deleteConfirmModal" class="fixed inset-0 z-50 modal-overlay opacity-0 pointer-events-none transition-opacity duration-200">
 ...
 <script>
        ...
        // ===== MODAL FUNCTIONS =====
        function openPreOralDefenseModal() {
            // Set up the modal for pre-oral defense
...
window.openPreOralDefenseModal = openPreOralDefenseModal;
