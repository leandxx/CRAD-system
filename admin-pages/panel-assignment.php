...
$emailContent = "
    ...
    <body>
        ...
        <p>
            <a href='http://localhost/CRAD-system/api/confirm-invitation.php?token=$token&status=accepted' style='background-color: #4CAF50; color: white; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; border-radius: 5px; margin-right: 10px;'>Accept Invitation</a>
            <a href='http://localhost/CRAD-system/api/confirm-invitation.php?token=$token&status=rejected' style='background-color: #f44336; color: white; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; border-radius: 5px;'>Decline Invitation</a>
        </p>
...
<head>
    ...
    <title>SMS | Panel Management</title>
    <link rel="icon" href="assets/img/sms-logo.png" type="image/png">
    <link rel="stylesheet" href="../assets/css/style-panel-assignment.css">
