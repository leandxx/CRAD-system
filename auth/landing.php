...
<section class="hero-slant-section position-relative">
  ...
  <div class="hero-logo-slant">
    <img src="../assets/img/sms.png" alt="Logo" />
  </div>
  <div class="hero-student-slant">
    <img src="../assets/img/hero.png" alt="Student Images" />
  </div>
</section>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-6 mb-4 mb-md-0 text-center">
        <img src="../assets/img/studs.jpg" class="img-fluid rounded w-75" alt="About Us Image">
      </div>
      <div class="col-md-6">
