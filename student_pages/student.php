            ...
            <main class="flex-1 overflow-y-auto p-6 hide-scrollbar">
                ...
                <section class="mb-8 animate__animated animate__fadeInUp">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <a href="defense-scheduling.php" class="bg-white rounded-xl shadow-md p-6 card-hover transition-all duration-300 border-l-4 border-green-500 hover:border-green-600 group">
                            <div class="flex items-center space-x-4">
                        ...
                        <a href="document-tracker.php" class="bg-white rounded-xl shadow-md p-6 card-hover transition-all duration-300 border-l-4 border-purple-500 hover:border-purple-600 group">
                            <div class="flex items-center space-x-4">
